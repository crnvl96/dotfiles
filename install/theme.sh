...
ln -snf ~/.config/dotfiles/themes/everforest ~/.config/dotfiles/current/theme
source ~/.local/share/dotfiles/themes/everforest/backgrounds.sh
ln -snf ~/.config/dotfiles/backgrounds/everforest ~/.config/dotfiles/current/backgrounds
ln -snf ~/.config/dotfiles/current/backgrounds/1-everforest.jpg ~/.config/dotfiles/current/background
